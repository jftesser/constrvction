class Design < ActiveRecord::Base
  ...
  belongs_to :texture
  belongs_to :user
  attr_accessible :form_id, :texture_id, :image_data, :title, :description, :preview, :front_texture, :back_texture, :front_texture_x, :front_texture_y, :back_texture_x, :back_texture_y, :front_texture_data, :back_texture_data
